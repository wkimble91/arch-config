...
AddPackage ttf-cinecaption # A cinematic Japanese font
...
AddPackage ttf-kochi-substitute # High quality Japanese TrueType fonts
...
AddPackage ttf-quicksand-variable # A sans serif typeface designed by Andrew Paglinawan using geometric shapes
...
CreateLink /etc/fonts/conf.d/10-scale-bitmap-fonts.conf /usr/share/fontconfig/conf.default/10-hinting-slight.conf
